                    ...
                    <form action="{{ route('berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @if ($errors->has('title')) is-invalid @endif"
                                name="title" value="{{ old('title', $berita->title) }}" placeholder="Masukkan Judul Post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @if ($errors->has('content')) is-invalid @endif" name="content" rows="5"
                                id="editor" placeholder="Masukkan Konten Post">{{ old('content', $berita->content) }}</textarea>
                            {{-- <div id="editor"></div> --}}
                        ...
                        <div class="form-group">
                            ...
                            <input name="tags" id="tags" value="{{ old('tags', $berita->tags) }}"
                                class="form-control">
